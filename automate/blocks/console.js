Blockly.Blocks['console'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField("  expect ")
        .appendField(new Blockly.FieldDropdown([["->","console_arrow_id"], ["#","console_hash_id"]]), "console_expect")
        .appendField("  prompt ")
        .appendField("   Id ")
...
Blockly.Blocks['telnet'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField("  expect ")
        .appendField(new Blockly.FieldDropdown([["->","telnet_arrow_id"], ["#","telnet_hash_id"]]), "telnet_expect")
        .appendField("  prompt ")
        .appendField("   Id ")
...
Blockly.Blocks['tl1'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField("  expect ")
        .appendField(new Blockly.FieldDropdown([[">","tl1_carrot_id"], ["#","tl1_hash_id"]]), "tl1_expect")
        .appendField("  prompt ")
        .appendField("   Id ")
